   ...
   <body>
            ...
            <div class="content">
               <div class="team row">
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        <div class="TopImg">
                           <img src="<?php echo base_url(); ?>assets/img/images.jpg" class="rounded-circle w-100 d-block">
                        </div>
                        <div class="TeamInfo text-center">
                           <div class="Name">Rahasia</div>
                           <div class="bio">Sangat Rahasia</div>
                           <div class="Job">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</div>
                           <div class="social_links">
                              <div class="social">
                                 <a href="https://www.youtube.com/@kaseps8304/videos" target="_blank"><i class="fab fa-github" aria-hidden="true"></i></a>
                              </div>
                              <div class="social">
                              <a href="https://www.youtube.com/@kaseps8304/videos" target="_blank"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                              </div>
                              <div class="social">
                                 <a href="https://www.youtube.com/@kaseps8304/videos" target="_blank"><i class="fab fa-facebook" aria-hidden="true"></i></a>
                              </div>
                              <div class="social">
                              <a href="https://www.youtube.com/@kaseps8304/videos" target="_blank"><i class="fab fa-twitter" aria-hidden="true"></i></a>
                              </div>
                           </div>
                        </div>
                     </div>
      ...
      <div class="Footer" id="Footer">
         <div class="container">
            ...
            <span>Kasep_Code | Penggajian 2023 | Repost by <a href='https://www.youtube.com/@kaseps8304/videos' title='StokCoding.com' target='_blank'>Kasep_Code</a>
